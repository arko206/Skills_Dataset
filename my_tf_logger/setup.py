...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'demo_test_log_motion= my_tf_logger.demo_test_log_motion:main',
            'replay_filtered_floor_to_base= my_tf_logger.replay_filtered_floor_to_base:main',
            'plot_floor_xy_yaw= my_tf_logger.plot_floor_xy_yaw:main',
